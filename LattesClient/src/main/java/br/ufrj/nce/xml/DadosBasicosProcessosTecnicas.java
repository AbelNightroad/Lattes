...
public class DadosBasicosProcessosTecnicas {
	
	@XStreamAlias("NATUREZA")
	@XStreamAsAttribute
	private String natureza;
	
	@XStreamAlias("TITULO-DO-PROCESSO")
	@XStreamAsAttribute
	...
	@XStreamAlias("MEIO-DE-DIVULDACAO")
	@XStreamAsAttribute
	...
	@XStreamAlias("TITULO-DO-PROCESSO-INGLES")
	@XStreamAsAttribute
	private String tituloProcessoIngles;
	...
	public String getTituloProcessoIngles() {
		return tituloProcessoIngles;
	}

	public void setTituloProcessoIngles(String tituloProcessoIngles) {
		this.tituloProcessoIngles = tituloProcessoIngles;
	}
