...
public class DadosBasicosCursoCurtaDuracao {
	...
	public String getMeioDuvulgacao() {
		return meioDuvulgacao;
	}

	public void setMeioDuvulgacao(String meioDuvulgacao) {
		this.meioDuvulgacao = meioDuvulgacao;
	}
