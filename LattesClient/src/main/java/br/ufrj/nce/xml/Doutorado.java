...
public class Doutorado {
	...
	public void setCodigoInstituicaoOutraCoTutela(String codigoInstituicaoOutraCoTutela) {
	...
	public String getNomeOrientadorSanduiche() {
		return nomeOrientadorSanduiche;
	}
	...
	public void setCodigoInstituicaoOutraSanduiche(String codigoInstituicaoOutraSanduiche) {
