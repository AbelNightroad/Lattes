...
public class DetalhamentoProcessosTecnicas {
	...
	@XStreamAlias("CIDADE-DO-PROCESSO")
	@XStreamAsAttribute
	private String cidadeProcesso;
	...
	public String getCidadeProcesso() {
		return cidadeProcesso;
	}

	public void setCidadeProcesso(String cidadeProcesso) {
		this.cidadeProcesso = cidadeProcesso;
	}
